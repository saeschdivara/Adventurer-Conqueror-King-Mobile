 ...
 */
public class OldDragon extends Npc {
        ...
        while (powerList.size() < amount) {
            ...
            switch (random) {
                ...
                case 8:
                    ...
                    if (routine.remove("Claw 2D4,Claw 2D4,Bite 3D10")) {
                        routine.add("Claw 1D10,Claw 1D10,Bite 4D8");
                    }
    ...
    private static List<Npc> createMonster(int groupSize) {
        ...
        for (int i = 1; i <= groupSize; i++) {
            OldDragon monster = new OldDragon();
            monster.addToAttackRoutine("Claw 2D4,Claw 2D4,Bite 3D10");
//            monster.setAdditionalHitPoints(0);
            canSpeak = BaseDragon.checkIfCanSpeak(50);
...
//            monster.addExtraInformation(BaseDragon.awake(40)); //Values in the Core book depict awake not asleep!
    ...
    private String spellsifcanSpeak() {
            ...
            dragonspell.setSpellsMemmorizedArcane(4, 1);
