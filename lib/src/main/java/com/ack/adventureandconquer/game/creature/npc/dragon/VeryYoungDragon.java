 ...
 */
public class VeryYoungDragon extends Npc {
        ...
        while (powerList.size() < amount) {
            ...
            switch (random) {
                ...
                case 8:
                    ...
                    if (routine.remove("Claw 1D3,Claw 1D3,Bite 2D4")) {
    ...
    private static List<Npc> createMonster(int groupSize) {
        ...
        for (int i = 1; i <= groupSize; i++) {
            VeryYoungDragon monster = new VeryYoungDragon();
            monster.addToAttackRoutine("Claw 1D3,Claw 1D3,Bite 2D4");
//            monster.setAdditionalHitPoints(0);
            canSpeak = BaseDragon.checkIfCanSpeak(2);
