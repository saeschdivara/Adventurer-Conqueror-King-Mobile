 ...
 */
public class VenerableDragon extends Npc {
            ...
            switch (random) {
                ...
                case 5:
                    if (!powerList.contains(random)) {
                        ...
                        monster.setArmorClass(monster.getArmorClass() + 4);//AC+3 if Very Old, AC+4 if Venerable
                ...
                case 8:
                    ...
                    if (routine.remove("Claw 3D4,Claw 3D4,Bite 5D8")) {
                        routine.add("Claw 3D6,Claw 3D6,Bite 6D8");
                    }else if (routine.remove("Claw 3D6,Claw 3D6,Bite 6D8")) {
                        routine.add("Claw 3D8,Claw 3D8,Bite 6D10");
                    }else if (routine.remove("Claw 3D6,Claw 3D6,Bite 6D8")) {
                        routine.add("Claw 3D10,Claw 3D10,Bite 7D10");
                    }
    ...
    private static List<Npc> createMonster(int groupSize) {
        ...
        for (int i = 1; i <= groupSize; i++) {
            VenerableDragon monster = new VenerableDragon();
            monster.addToAttackRoutine("Claw 3D4,Claw 3D4,Bite 5D8");
//            monster.setAdditionalHitPoints(0);
            canSpeak = BaseDragon.checkIfCanSpeak(100);
            monster.generatePowers(3, monster);
...
//            monster.addExtraInformation(BaseDragon.awake(40)); //Values in the Core book depict awake not asleep!
    ...
    private String spellsifcanSpeak() {
            ...
            dragonspell.addFavoriteSpell(3, Spell.HASTE, 10);
            ...
            dragonspell.setSpellsMemmorized(4, 3, false);
            dragonspell.addSpells(5, Spell.ARCANE5);
            dragonspell.setSpellsMemmorized(5, 2, false);
