 ...
 */
public class SpawnDragon extends Npc {
        ...
        while (powerList.size() < amount) {
            ...
            switch (random) {
                ...
                case 8:
                    ...
                    if (routine.remove("Claw 1D2,Claw 1D6,Bite 2D8")) {
    ...
    private static List<Npc> createMonster(int groupSize) {
        ...
        for (int i = 1; i <= groupSize; i++) {
            SpawnDragon monster = new SpawnDragon();
            monster.addToAttackRoutine("Claw 1D2,Claw 1D2,Bite 2D3");
//            monster.setAdditionalHitPoints(0);
            canSpeak = BaseDragon.checkIfCanSpeak(1);
//            monster.generatePowers(0, monster);
...
//            monster.addExtraInformation(BaseDragon.awake(50)); //Values in the Core book depict awake not asleep!
    ...
    private String spellsifcanSpeak() {
            ...
            dragonspell.setSpellsMemmorizedArcane(1, 1);
