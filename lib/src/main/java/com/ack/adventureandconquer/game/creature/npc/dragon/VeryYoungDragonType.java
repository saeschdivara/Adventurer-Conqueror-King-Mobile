 ...
 */
public class VeryYoungDragonType implements IsNpcType {

    public VeryYoungDragonType(String type,String breathAttack) {
        VeryYoungDragon.setDragonType(type,breathAttack);
    }
...
//    }
    ...
    @Override
    public List<Npc> getNormalWildnessEncounter() {
        return VeryYoungDragon.getGroup();
    }
