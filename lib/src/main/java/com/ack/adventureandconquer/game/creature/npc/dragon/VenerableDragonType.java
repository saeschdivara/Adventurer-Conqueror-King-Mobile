 ...
 */
public class VenerableDragonType implements IsNpcType {

    public VenerableDragonType(String type,String breathAttack) {
        VenerableDragon.setDragonType(type,breathAttack);
    }
...
//    }
    ...
    @Override
    public List<Npc> getNormalWildnessEncounter() {
        return VenerableDragon.getGroup();
    }
