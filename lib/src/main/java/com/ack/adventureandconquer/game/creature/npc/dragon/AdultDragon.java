 ...
 */
public class AdultDragon extends Npc {
        ...
        while (powerList.size() < amount) {
            ...
            switch (random) {
                ...
                case 8:
                    ...
                    if (routine.remove("Claw 2D3,Claw 2D3,Bite 2D10")) {
                        routine.add("Claw 1D8,Claw 1D8,Bite 3D8");
                    }
    ...
    private static List<Npc> createMonster(int groupSize) {
        ...
        for (int i = 1; i <= groupSize; i++) {
            AdultDragon monster = new AdultDragon();
            monster.addToAttackRoutine("Claw 2D3,Claw 2D3,Bite 2D10");
//            monster.setAdditionalHitPoints(0);
            canSpeak = BaseDragon.checkIfCanSpeak(20);
