 ...
 */
public class VeryOldDragon extends Npc {
            ...
            switch (random) {
                ...
                case 5:
                    if (!powerList.contains(random)) {
                        ...
                        monster.setArmorClass(monster.getArmorClass() + 3);//AC+3 if Very Old, AC+4 if Venerable
                ...
                case 8:
                    ...
                    if (routine.remove("Claw 1D10,Claw 1D10,Bite 4D8")) {
                        routine.add("Claw 1D12,Claw 1D12,Bite 4D10");
                    }else if (routine.remove("Claw 1D12,Claw 1D12,Bite 4D10")) {
                        routine.add("Claw 3D4,Claw 3D4,Bite 5D8");
                    }
    ...
    private static List<Npc> createMonster(int groupSize) {
        ...
        for (int i = 1; i <= groupSize; i++) {
            VeryOldDragon monster = new VeryOldDragon();
            monster.addToAttackRoutine("Claw 1D10,Claw 1D10,Bite 4D8");
//            monster.setAdditionalHitPoints(0);
            canSpeak = BaseDragon.checkIfCanSpeak(75);
            monster.generatePowers(2, monster);
...
//            monster.addExtraInformation(BaseDragon.awake(40)); //Values in the Core book depict awake not asleep!
    ...
    private String spellsifcanSpeak() {
            ...
            dragonspell.setSpellsMemmorizedArcane(3, 2);
