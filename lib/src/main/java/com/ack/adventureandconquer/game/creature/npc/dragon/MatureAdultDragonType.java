 ...
 */
public class MatureAdultDragonType implements IsNpcType {

    public MatureAdultDragonType(String type,String breathAttack) {
        MatureAdultDragon.setDragonType(type,breathAttack);
    }
...
//    }
    ...
    @Override
    public List<Npc> getNormalWildnessEncounter() {
        return MatureAdultDragon.getGroup();
    }
