 ...
 */
public class MatureAdultDragon extends Npc {
        ...
        while (powerList.size() < amount) {
            ...
            switch (random) {
                ...
                case 8:
                    ...
                    if (routine.remove("Claw 1D8,Claw 1D8,Bite 3D8")) {
                        routine.add("Claw 2D4,Claw 2D4,Bite 3D10");
                    }
    ...
    private static List<Npc> createMonster(int groupSize) {
        ...
        for (int i = 1; i <= groupSize; i++) {
            MatureAdultDragon monster = new MatureAdultDragon();
            monster.addToAttackRoutine("Claw 1D8,Claw 1D8,Bite 3D8");
//            monster.setAdditionalHitPoints(0);
            canSpeak = BaseDragon.checkIfCanSpeak(35);
